defmodule Vtc.Rates do
  ...
  def f23_98, do: Framerate.new!(Ratio.new(24_000, 1001), ntsc: :non_drop)
  ...
  def f29_97_ndf, do: Framerate.new!(Ratio.new(30_000, 1001), ntsc: :non_drop)
  ...
  def f47_95, do: Framerate.new!(Ratio.new(48_000, 1001), ntsc: :non_drop)
  ...
  def f59_94_ndf, do: Framerate.new!(Ratio.new(60_000, 1001), ntsc: :non_drop)
